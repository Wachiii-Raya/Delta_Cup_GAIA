...
mycursor.execute("CREATE TABLE IF NOT EXISTS 6_axis (id int PRIMARY KEY AUTO_INCREMENT, Func_1 BOOLEAN NOT NULL, Func_2 BOOLEAN NOT NULL, Func_3 BOOLEAN NOT NULL, Func_4 BOOLEAN NOT NULL, Func_5 BOOLEAN NOT NULL, Func_6 BOOLEAN NOT NULL)")
mycursor.execute("DESCRIBE 6_axis")
...
[mycursor.execute(f"INSERT INTO 6_axis(Func_1, Func_2, Func_3, Func_4, Func_5, Func_6) VALUES (0,0,0,0,0,0)")]
db.commit()
...
def pump_to_tube():
    for round in range(2):
        for pos in range(1,13): #round 1 pos = 1-2 wait for placing
            ...
            time.sleep(10)  # time delay ตอนรอ 6-axis ขยับ
